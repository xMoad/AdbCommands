...
if len(sys.argv) > 1:
	...
	if (serial) == "BUC4C16727006201":
		...
		execfile(r'C:\TestStand AIVI\fMBT\Huawei\PlayTrack.py')
		
	if (dut.serialNumber) == "04cdda6a00747559":
		print("Nexus_5 is connected, related scripts will be executed")
		execfile(r'C:\TestStand AIVI\fMBT\Nexus_5\PlayTrack.py')
